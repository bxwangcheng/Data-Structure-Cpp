...
#include "01.DataStructure&Algorithm/01.Sort&Search/main_sort.h"
#include "01.DataStructure&Algorithm/02.LinkedList/main_list.h"
...
int main(void) {
	...
	//	if (rand_index > 15) {
	//		print_to_console_ln("fuck!");
	//		return;
	//	}
	//}
	//vector<int> a = { 3, 2, 7, 3, 1, 2, 6 };
	//print_vector(a);
	//bubble_sort(a);
	//print_vector(a);
